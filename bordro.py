...
c = canvas.Canvas(".EKSİK" + str(tarihh) + str(tar)+".pdf")
...
for ayliste in cliste:
    for gunliste in ayliste:
        ...
        print (gunliste[0],gunliste[1],gunliste[2],gunliste[3])
        if (str(gunliste[3])).isalpha():

            c.drawString(10, 800 - (15 * (bb + 1)), str(gunliste[4]))
    ...
    c.setFont("Verdana", 11)
    c.drawString(10, 800 - (15 * (bb + 1)), "Gelmedi ")
    c.drawString(60, 800 - (15 * (bb + 1)), str(toplam2)+" ")
    c.drawString(80, 800 - (15 * (bb + 1)), "Eksik ")
    c.drawString(120, 800 - (15 * (bb + 1)), str(toplam1)+" ")
    c.drawString(140, 800 - (15 * (bb + 1)), "Toplam ")
    c.drawString(190, 800 - (15 * (bb + 1)), str(toplam)+" dk")
    c.drawString(240, 800 - (15 * (bb + 1)), cevirgunsaat(toplam))
    c.drawString(410, 800 - (15 * (bb )), "SONUÇ")
    c.drawString(380, 800 - (15 * (bb + 1)), cevirgunsaat(toplam-toplam1*240))
